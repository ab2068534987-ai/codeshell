...
class SessionMeta:
    ...
    def save(self, path: Path) -> None:
        data = {
            ...
            "context_baseline_tokens": self.context_baseline_tokens,
            "context_anchor_count": self.context_anchor_count,
    ...
    def load(cls, path: Path) -> SessionMeta | None:
        try:
            ...
            return cls(
                ...
                context_baseline_tokens=data.get("context_baseline_tokens", 0),
                context_anchor_count=data.get("context_anchor_count", 0),
...
class Session:
    ...
    def update_context_usage_anchor(self, conversation: ConversationManager) -> None:
        self.meta.context_baseline_tokens = conversation.baseline_tokens
        self.meta.context_anchor_count = conversation.anchor_count
        self.meta.last_active = datetime.now(timezone.utc)
        self.meta.save(self._sessions_dir / f"{self.session_id}.meta")
