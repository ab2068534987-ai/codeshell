...
def load_instructions(project_root: str) -> str:
    ...
    2. 项目目录链：从 git root 到 workDir，每个目录的 CODESHELL.md 和 AGENTS.md
    3. workDir/.codeshell/INSTRUCTIONS.md（遗留格式）
    4. workDir/CODESHELL.local.md（本地覆盖）
    """
    ...
    # 3. 遗留格式
    _add(root / ".codeshell" / "INSTRUCTIONS.md")
