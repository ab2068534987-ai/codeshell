...
class ConversationManager:
    ...
    def restore_usage_anchor(self, baseline_tokens: int, anchor_count: int) -> None:
        ...
        self.anchor_count = max(0, min(int(anchor_count), len(self.history)))
        self.last_input_tokens = baseline
